  ...
  <div class="t-container">
    ...
    <div class="bottom-box">
      ...
      <div class="list-box">
        ...
        >
          <el-table-column fixed prop="id" label="Branch ID"> </el-table-column>
          <el-table-column prop="date" label="Branch name"> </el-table-column>
          <el-table-column prop="amount" label="Mobile number">
          </el-table-column>
          <el-table-column prop="payer" label="Merchant name">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    goView(item) {
      this.$router.push("/merchant-detail/" + item.id);
    },
    changePage(val) {},
    changeType(num) {
      this.listType = num;
