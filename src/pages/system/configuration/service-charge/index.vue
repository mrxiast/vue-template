    ...
    <div class="bottom-box">
      <div class="list-box">
        ...
        >
          ...
          <el-table-column prop="date" label="Account level"> </el-table-column>
        ...
        <div id="print">
          <div class="tran-box">
            ...
            <div class="account-level">
              <div class="level-title">Please select account level:</div>
              <div>
                <el-select v-model="accountLevel" placeholder="请选择">
                  <el-option
          ...
          <div class="tran-box">
            ...
            <div class="item-box">
              <div class="item-title">Cash in - OTC</div>
              <div class="item-con">
            ...
            <div class="item-box">
              <div class="item-title">Cash out - OTC</div>
              <div class="item-con">
                <el-button size="small" type="text">Completed</el-button>
              </div>
            </div>
            <div class="item-box">
              <div class="item-title">Net-banking</div>
              <div class="item-con">
                <el-button size="small" type="text">Completed</el-button>
              </div>
            </div>
