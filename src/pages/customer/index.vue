  ...
  <div class="container">
    ...
    <div class="table-box">
      <div class="list-box">
        ...
        >
          <el-table-column fixed prop="id" label="user ID"> </el-table-column>
          <el-table-column prop="date" label="user type"> </el-table-column>
          <el-table-column prop="date" label="FP account ID"> </el-table-column>
          <el-table-column prop="amount" label="Referral code">
          </el-table-column>
          <el-table-column prop="amount" label="Name"> </el-table-column>
          <el-table-column prop="amount" label="Mobile number">
          </el-table-column>
          <el-table-column prop="amount" label="Registration date">
          </el-table-column>
